...
//Підсумок
//===========================================
//*Функція setTimeout() відпрацьовує синхронно й реєструє відкладений виклик переданої callback-функції. 
Ця функція буде викликана асинхронно, через вказаний проміжок часу. Вона не викликає функцію безпосередньо,
 а лише планує її виконання через певний час.
 приймає два параметри:
callback-функцію, яка буде викликана після закінчення часу;
delay - час, після якого буде викликана функція.
...
console.log(date);
// "Fri Jun 18 2021 15:01:35 GMT+0300 (Eastern European Summer Time)" //поточні дату і час.
Через цей ідентифікатор можна також установити яку хочеш дату!
