...
Kahoot:
// * event.target - в цій властивості зберігається посилання на цільовий елемент - на якому сталася подія. Або хто її викликав. 
//* event.stopPropagation() - зупиняє спливання.
//* спливання подій дозволяє реалізувати такий важливий "прийом" як - делегування подій. Слухач подій вішається на кожному батьківському елементі а не на кожен елемент.
//* Бібліотеки:npmjs.com, cdnjs.com, jsdelivr.com;